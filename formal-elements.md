...
####	מה שונה במשחק שלנו:
**Rewild**  הוא משחק קופסא ששם דגש על שיקום סביבתי כללי. המשחק שלנו ייחודי בכך שהוא מתמקד באיומים סביבתיים ממשיים ומספק כוחות לשחקן להתמודד עימם באופן פעיל ובזמן אמת.
#### 2.	Eco
####  קישור וצילום מסך:
...
#### מה שונה במשחק שלנו:
**Eco** מתמקד בקהילה ובפיתוח ציוויליזציה תוך שמירה על הסביבה. המשחק שלנו הוא אסטרטגי ויחידני עם דגש על התמודדות עם מכשולים הנגרמים ישירות על ידי התערבות האדם.
### ייחודיות המשחק
